...
TOOLS_RU: dict[str, dict] = {
    ...
    "get_method": {
        ...
        "description": (
            ...
            "по source_rel, если загружены только сигнатуры."
        ),
        "parameters": {
            "context": _CTX_SINGLE,
    ...
    "find_code_references": {
        ...
        "description": (
            ...
            "(индекс code/full или файлы выгрузки при signatures)."
        ),
        "parameters": {
            "context": _CTX_SINGLE,
            "name": "Идентификатор для поиска в телах методов BSL",
            "parent_path": "Необязательный фильтр по префиксу пути модуля",
