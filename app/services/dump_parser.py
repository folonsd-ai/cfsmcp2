...
class DumpScanner:
    ...
    def _process_object(
        ...
        from app.services.guid_lookup import elem_uuid
        ...
        records = [_dump_record(path, ru_plural, kind, props, guid=elem_uuid(elem))]
    ...
    def _walk_children(
        ...
        for child in co:
            ...
            records.append(
                _dump_record(cpath, ckind_ru, ckind, cprops, guid=elem_uuid(child))
            )
